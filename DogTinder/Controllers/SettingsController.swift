...
class SettingsController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func createButton(selector: Selector) -> UIButton {
        ...
        // selector sets the target when touched
    ...
    override func viewDidLoad() {
        ...
        //sets up the top bar options : cancel, save and logout
        setupNavigationItems()
        
        tableView.backgroundColor = UIColor(white: 0.95, alpha: 1)
        
        //removes horizontal lines in the table view
    ...
    fileprivate func loadUserPhotos(){
        ...
        // loads them into our cache instead, saves time and resources
    ...
    lazy var header: UIView = {
        ...
        // creates the 1 * (top/bottom) grid for photos
        // first left photo
    ...
    // for 0 (photos) need 0, for 1-4 need 1
