...
//  DogTinder
//
//  Created by Nagasaki on 17/02/19.
...
class HomeController: UIViewController, SettingsControllerDelegate, LoginControllerDelegate, CardViewDelegate{
    ...
    let bottomControls = HomeBottonControlsStackView()
    ...
    fileprivate func saveSwipeToFirestore(didLike: Int) {
        ...
        Firestore.firestore().collection("swipes").document(uid).getDocument { (snapshot, err) in
            ...
            if snapshot?.exists == true {
                //when there is already swipes recoreded for the user
                ...
                //no swipes for the user, first swipe
    ...
    fileprivate func fetchUsersFromFirestore(){
        ...
        query.getDocuments { (snapshot, err) in
            ...
            // we are going to set up the nextCardView relations
    ...
    fileprivate func setupFirestoreUserCards(){
        cardViewModels.forEach { (cardVM) in
            ...
            //calls the method to set the cardView Model
