...
//  DogTinder
//
//  Created by Nagasaki on 20/03/19.
...
class MatchView: UIView {
    ...
    fileprivate func setupAnimations() {
        //display all the views which are hidden -> alpha goes from 0 to 1
        //$0 for each loop shorter version, for each view set alpha to 1
        ...
        //moves the two button to their default positions
